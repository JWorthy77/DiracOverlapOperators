...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine fermionforceJW(ut,ps,dSdA) ! for Seff=1/2phi ...  phi
      use gammas
      use WilsonDirac
      use domainwallmod
      implicit none
      ...
      call DomainWallDerivs(dSdA,R1,R2,.true.,KTYPE,baremass)

      MTYPE=1
      call DomainWallDerivs(dSdA1,R1,ps,.true.,KTYPE,one)
      dSdA=-dSdA+dSdA1
